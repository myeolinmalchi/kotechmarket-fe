            ...
            >
              ...
              <TableWrapper Color={Color}>
                {isDesktop && (
                  <tbody>
                    <TableRow>
                      <TableHeaderCell colSpan={2}>기술명</TableHeaderCell>
                    </TableRow>
                    <TableRow>
                      <TableCell colSpan={2}>Content 2</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableHeaderCell>중요키워드</TableHeaderCell>
                    ...
                    <TableRow>
                      <TableHeaderCell>출원번호</TableHeaderCell>
                      <TableHeaderCell>등록번호</TableHeaderCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Content 2</TableCell>
                      <TableCell>Content 2</TableCell>
                    ...
                    <TableRow>
                      <TableHeaderCell>권리구분</TableHeaderCell>
                      <TableHeaderCell>권리기간</TableHeaderCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Content 2</TableCell>
                      <TableCell>Content 2</TableCell>
                    ...
                    <TableRow>
                      ...
                      <TableHeaderCell>저널</TableHeaderCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Content 2</TableCell>
                      <TableCell>Content 2</TableCell>
                    ...
                    <TableRow>
                      <TableHeaderCell>대표 연구자</TableHeaderCell>
                      <TableHeaderCell>공동 연구자</TableHeaderCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Content 2</TableCell>
                      <TableCell>Content 2</TableCell>
              ...
              <ContentSubtitle style={{ ...Font.title.subhead3 }}>
                기술요약
              </ContentSubtitle>
              <span
                style={{
              ...
              >
                <span style={{ ...Font.body.body2, color: Color.text.primary }}>
                  기술이전 상담 신청
                </span>
              </AISummaryContainer>
              <AISummaryContainer
