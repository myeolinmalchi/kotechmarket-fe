...
const ThumbnailUploader = ({
  ...
  thumbnail: FileType;
  setThumbnail: React.Dispatch<React.SetStateAction<FileType>>;
}) => {
  const { Color } = useStyleContext();
  return (
    <div
...
const news = () => {
  ...
  const [thumbnail, setThumbnail] = React.useState<FileType>({} as FileType);
    ...
    <Container Color={Color}>
        ...
        <>
          ...
          {generated && (
            <>
              ...
              <Spacer height={28} />
              <GenerationController title={'제목'} />
              <Spacer height={16} />
              <TextField size={'L'} />
              <Spacer height={24} />
              <GenerationController title={'부제목'} />
              <Spacer height={16} />
              <TextField size={'L'} />
              <Spacer height={24} />
              <GenerationController title={'썸네일'} onlyRegenerate />
              <Spacer height={16} />
              <ThumbnailUploader
                thumbnail={thumbnail}
              ...
              <Spacer height={28} />
              <GenerationController title={'본문내용'} />
              <Spacer height={16} />
              <TextField size={'L'} />
              <Spacer height={60} />
              <span
              ...
              <Spacer height={28} />
              <GenerationController title={'중요 키워드'} />
              <Spacer height={16} />
              <TextField size={'L'} />
              <Spacer height={24} />
              <GenerationController title={'기자 정보'} />
              <Spacer height={16} />
              <TextField size={'L'} />
              <Spacer height={60} />
              <span
      ...
      {generated && (
        ...
        >
          ...
          <DefaultButton
            style={'PRIMARY'}
            state={selectedType ? 'DEFAULT' : 'DISABLED'}
          >
            등록하기
          </DefaultButton>
        </div>
